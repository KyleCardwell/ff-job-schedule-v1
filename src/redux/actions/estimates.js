  ...
  return async (dispatch) => {
    try {
      ...
      const estimate = {
        ...
        default_include_door_pulls: data.default_include_door_pulls,
        default_include_drawer_pulls: data.default_include_drawer_pulls,
        ...
        .insert([
          {
            ...
            include_door_pulls: include_door_pulls !== undefined ? include_door_pulls : null,
            include_drawer_pulls: include_drawer_pulls !== undefined ? include_drawer_pulls : null,
  ...
  return async (dispatch) => {
    try {
      ...
      const updatePayload = {
        ...
        ...(include_door_pulls !== undefined && { include_door_pulls }),
        ...(include_drawer_pulls !== undefined && { include_drawer_pulls }),
        ...
        ...(door_finish !== undefined && { door_finish: door_finish }),
        ...(drawer_front_finish !== undefined && { drawer_front_finish: drawer_front_finish }),
        ...(quantity !== undefined && {
          quantity: quantity != null ? +quantity : 1,
        }),
        ...(profit !== undefined && {
  ...
  return async (dispatch) => {
    try {
      ...
      const updatePayload = {
        ...
        default_include_door_pulls: defaults.default_include_door_pulls ?? null,
        default_include_drawer_pulls: defaults.default_include_drawer_pulls ?? null,
