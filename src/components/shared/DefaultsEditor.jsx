...
const DefaultsEditor = ({ 
  ...
  const [formData, setFormData] = useState({
    ...
    door_reeded_panel: data.door_reeded_panel ?? data.default_door_reeded_panel ?? false,
    drawer_reeded_panel: data.drawer_reeded_panel ?? data.default_drawer_reeded_panel ?? false,
