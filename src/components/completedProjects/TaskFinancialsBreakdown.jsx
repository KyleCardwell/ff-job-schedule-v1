          ...
          return (
            <div key={id} className="py-2 hover:bg-gray-200">
               <div className="grid grid-cols-[100px_2fr_1fr_1fr_1fr] gap-4 text-sm">
                ...
                <div className="font-semibold capitalize text-gray-800">{sectionData.name}</div>
                <div className="text-right">
                  ${sectionData.estimate.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </div>
                <div className="text-right">
                  ${sectionData.actual_cost.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </div>
                <div className={`text-right mx-2 ${sectionData.estimate - sectionData.actual_cost >= 0 ? "text-green-600" : "text-red-600"}`}>
                  ${(sectionData.estimate - sectionData.actual_cost).toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                </div>
              </div>
            </div>
          );
