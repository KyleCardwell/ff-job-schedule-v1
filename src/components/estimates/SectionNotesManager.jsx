...
const SectionNotesManager = ({ notes, section, onSave }) => {
  ...
  const { autoGeneratedNotesText, autoGeneratedDoesNotIncludeText } = useMemo(() => {
    if (!section || !currentEstimate) return { autoGeneratedNotesText: "", autoGeneratedDoesNotIncludeText: "" };
    ...
    const { additionalNotesText, doesNotIncludeText } = buildAdditionalSectionNotesText({
      effectiveSection,
      hasDoors,
      hasDrawerFronts,
      hasDrawerBoxes,
    ...
    return { autoGeneratedNotesText: additionalNotesText, autoGeneratedDoesNotIncludeText: doesNotIncludeText };
  }, [
    section,
    currentEstimate,
    boxMaterials,
  ...
  return (
    <div className="p-4 bg-white">
      ...
      {(autoGeneratedNotesText || autoGeneratedDoesNotIncludeText) && (
