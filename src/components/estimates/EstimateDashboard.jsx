  ...
  const sections = [
    {
      ...
      title: "New Estimates",
      description:
        "Create new estimates for upcoming projects. Start the estimation process by entering basic project details and requirements.",
      icon: FiPlusCircle,
    ...
    },
    {
      ...
      description:
        "Continue working on draft estimates. Review, modify, and complete estimates that have been started but not yet finalized.",
      icon: FiEdit,
      ...
      count: estimates
        ? estimates.filter((est) => est.status === ESTIMATE_STATUS.DRAFT).length
        : 0,
    },
    {
      id: "finalized",
      ...
      description:
        "View and manage completed estimates. Access finalized estimates that are ready to be presented to clients or converted to projects.",
      icon: FiCheckCircle,
      ...
      count: estimates
        ? estimates.filter((est) => est.status === ESTIMATE_STATUS.FINALIZED)
            .length
        : 0,
    },
  ];
